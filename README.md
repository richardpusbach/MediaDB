...
### Troubleshooting: `P3018` after an old failed migration
If Prisma reports a failed migration like `202602..._init` and blocks new migrations, clear local dev schema history and re-run setup:
...
if (Test-Path .\prisma\migrations) {
  ...
  if ($hasVector) { rd /s /q .\prisma\migrations }
}
